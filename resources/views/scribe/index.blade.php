...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "https://sanlex.local";
        var useCsrf = Boolean();
...
<aside>
    <strong>Base URL</strong>: <code>https://sanlex.local</code>
</aside>
...
<div class="bash-example">
    ...
    --get "https://sanlex.local/api/user" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "https://sanlex.local/api/healthcheck" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "https://sanlex.local/api/healthcheck"
);
