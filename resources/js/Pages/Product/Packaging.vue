        ...
        <div class="content">
            <div class="content-header">
                <div class="mt-auto mb-0">
                    <div class="text-lg font-semibold">{{ $t('base.packaging') }}</div>
                </div>
                <div class="mt-auto mb-0">
...
<script setup>
        ...
        formRef.value.validate(async (valid) => {
            if (valid) {
                ...
                try {
                    ...
                    const url = form.value.id ? `/product/packaging/${form.value.id}/update` :
    ...
    const onDelete = (id) => {
        ElMessageBox.confirm(t("message.delete_confirm"), t('message.delete_confirm_title'), {
            ...
            axios.delete(`/product/packaging/${id}/delete`).then(() => {
                refetch();
                ElMessage({
                    type: 'success',
