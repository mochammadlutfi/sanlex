        ...
        <div class="content">
            <div class="content-header">
                <div class="mt-auto mb-0">
                    <div class="text-lg font-semibold">{{ $t('base.branch') }}</div>
                </div>
                <div class="mt-auto mb-0">
                    <el-breadcrumb separator="/">
                        <el-breadcrumb-item :to="{ path: '/dashboard' }">{{ $t('base.dashboard') }}
                        </el-breadcrumb-item>
                        <el-breadcrumb-item>{{ $t('base.branch') }}</el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
            </div>
            ...
            <el-card body-class="!p-0" class="!rounded-lg !shadow-md !mb-10">
                <div class="flex justify-between items-center p-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <el-button :tag="Link" href="/branch/create" type="primary">
                                        ...
                                        <template #dropdown>
                                            <el-dropdown-menu>
                                                <el-dropdown-item class="flex justify-between">
                                                    <Link :href="`/branch/${ scope.row.id }/edit`">
...
<script setup>
    ...
    const onDelete = (id) => {
        ElMessageBox.confirm(t("message.delete_confirm"), t('message.delete_confirm_title'), {
            ...
            axios.delete(`/product/branch/${id}/delete`).then(() => {
                refetch();
                ElMessage({
                    type: 'success',
